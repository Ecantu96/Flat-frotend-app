        ...
        return (
         ...
         <AppProvider>
          ...
          <ButtonAppBar></ButtonAppBar>   
			...
			<div className="col-md-4 relation_ship" style={{ background: '#fff', margin: '0 auto' }}>
                
				<div className="main_title">Relationship Status</div>
				
				<div className="type_list"> 
				<button data-toggle="tab" data-target="#page0" className="btn btn-default active btn-sm">Single</button>
				<button data-toggle="tab" data-target="#page1" className="btn btn-default btn-sm">On a Relationship</button>
				<button data-toggle="tab" data-target="#page2" className="btn btn-default btn-sm">Married</button>
				</div>
