...
class LookingInRoommate extends React.Component {
    ...
    render(){
		...
		<button data-toggle="tab" data-target="#page2" className="btn btn-default btn-sm">TIDY</button>
...
export default withStyles(styles, { withTheme: true })(LookingInRoommate);