...
class RelationshipStatus extends React.Component {
    ...
    render(){
		...
		<button data-toggle="tab" data-target="#page0" className="btn btn-default btn-sm">Single</button>
...
export default withStyles(styles, { withTheme: true })(RelationshipStatus);