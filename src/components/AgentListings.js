			        ...
			        <div className="col-sm-2 side_dashboard_list side_dashboard_list_desktop">
						...
						<Paper className={classes.paper}> 
							  <div className="dashboard_btns">
										...
										}} data-target="#page3" className="dashboard_btn active btn btn-default btn-sm">Listings</Button>
												<Button data-toggle="tab"  onClick={() => {
												  ...
												  <Zoom in={checked}>
													<div className="col-sm-2  side_dashboard_list_mobile">
														<Grid item xs={1}>
																	...
																	<Button data-toggle="tab" data-target="#page3" className="dashboard_btn active btn btn-default btn-sm">Listings</Button>
...
AgentListings = connect(mapStateToPropsN)(AgentListings);

export default withStyles(styles)(AgentListings);
